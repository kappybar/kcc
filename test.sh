...
assert 9 "{ a = b = 3;c = d = 2; return a * b + c - d;}"
assert 7 "{a = 3; b = 4; return a+b;}"
assert 11 "{return 5 * 3 - 4;a = 4 + 3;}"
assert 12 "{ bar; if (1) bar = 12; else bar = 3; return bar;}"
assert 10 "{foo = 3;bar = 4; if (foo == 3) bar = bar + 2; return foo +bar + 1;}"
...
assert 10 "{x = 4;y = &x; z = &y; **z = 10; return x;}"
assert 19 "{foo = 3;bar = 4; for (i = 0;i < 10;i = i + 1) if(i > 5) foo = foo + bar; return foo; }"
